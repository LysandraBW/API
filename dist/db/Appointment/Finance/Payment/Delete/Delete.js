...
exports.DeletePayment = exports.TestDeletePayment = void 0;
exports.ExecuteDeletePayment = ExecuteDeletePayment;
...
function ExecuteDeletePayment(data) {
...
exports.TestDeletePayment = zod_1.z.object(Object.assign(Object.assign({}, validate_1.appointmentTest), { paymentID: validate_2.isInteger }));
exports.DeletePayment = (0, Procedure_1.buildProcedure)(exports.TestDeletePayment, ExecuteDeletePayment);
