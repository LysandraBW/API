...
exports.DeletePart = exports.TestDeletePart = void 0;
exports.ExecuteDeletePart = ExecuteDeletePart;
...
function ExecuteDeletePart(data) {
...
exports.TestDeletePart = zod_1.z.object(Object.assign(Object.assign({}, validate_1.appointmentTest), { partID: validate_2.isInteger }));
exports.DeletePart = (0, Procedure_1.buildProcedure)(exports.TestDeletePart, ExecuteDeletePart);
