...
exports.InsertPart = exports.TestInsertPart = void 0;
exports.ExecuteInsertPart = ExecuteInsertPart;
...
function ExecuteInsertPart(data) {
...
exports.TestInsertPart = zod_1.z.object(Object.assign(Object.assign({}, validate_1.appointmentTest), { partName: zod_1.z.string().max(50), partNumber: zod_1.z.string().max(50), quantity: validate_2.isInteger, unitCost: validate_2.isMoney }));
exports.InsertPart = (0, Procedure_1.buildProcedure)(exports.TestInsertPart, ExecuteInsertPart);
