...
exports.DeleteService = exports.TestDeleteService = void 0;
exports.ExecuteDeleteService = ExecuteDeleteService;
...
function ExecuteDeleteService(data) {
...
exports.TestDeleteService = zod_1.z.object(Object.assign(Object.assign({}, validate_1.appointmentTest), { serviceID: validate_2.isInteger }));
exports.DeleteService = (0, Procedure_1.buildProcedure)(exports.TestDeleteService, ExecuteDeleteService);
