...
exports.InsertEvent = exports.TestInsertEvent = void 0;
exports.ExecuteInsertEvent = ExecuteInsertEvent;
...
function ExecuteInsertEvent(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const output = yield pool.request()
                ...
                .input("Date", mssql_1.default.VarChar(30), data.date)
                .input("Summary", mssql_1.default.VarChar(500), data.summary)
...
exports.TestInsertEvent = zod_1.z.object({
    sessionID: validate_1.isUUID,
    name: zod_1.z.string().max(100),
    date: validate_1.isDate,
    summary: zod_1.z.string().max(500)
});
exports.InsertEvent = (0, Procedure_1.buildProcedure)(exports.TestInsertEvent, ExecuteInsertEvent);
