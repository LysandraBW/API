...
export const TestInsertPayment = z.object({...appointmentTest, payment: isMoney});
export const InsertPayment = buildProcedure(TestInsertPayment, ExecuteInsertPayment);